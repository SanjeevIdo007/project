    ...
    <div className='bg-[#0A2342]/60 py-2 '>
      <div className='contianer flex justify-between items-center'>
        ...
        <div className='h-[50px] w-[50px] '> 
          <img src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=crop&w=200&q=80" alt="profilepPic" className='w-full h-full rounded-full' />
        </div>
        </div>
      </div>
    </div>
    ...
    <div className='flex justify-center items-center bg-[#F5F5F5] relative' >
       ...
       <div className=' flex items-center'>
         ...
         <li className='group relative py px-3'>
              <a href="property" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Property</a>
            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-[#000000] shadow-md'>
               <ul>
                  {Dropdownlinks1.map((data) => (
                    <li key={data.name}>
                      <a href={data.link} className='inline-block w-full rounded-md p-2 hover:bg-[#000000]/20'>
                        {data.name}
                      </a>
                    </li>
                  ))}
          ...
          <li className='group relative py px-3'>
              <a href="rent" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Rent</a>
            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-[#000000] shadow-md'>
               <ul>
          ...
          <li className='group relative py px-3'>
              <a href="sell" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Sell</a>
            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-[#000000] shadow-md'>
               <ul>
            ...
            {/* Buy DropDown starts */}
            <li className='group relative py px-3'>
              <a href="buy" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Buy</a>
            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-[#000000] shadow-md'>
               <ul>
           ...
           <li className='group relative py px-3'>
              <a href="space" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Spaces</a>
            <div className='absolute z-[9999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-[#000000] shadow-md'>
               <ul>
          ...
          <li className='group relative cursor-pointer py'>
              <a href="trending" className='flex items-center gap-[2px] py-2 text-[#000000] hover:text-[#0A2342]'>Trending 
                <span>
        ...
        {/* Post button */}
    <button onClick={() => alert('Post not available yet')} 
